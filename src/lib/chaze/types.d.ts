declare module 'littlejsengine' {
	 ...
	 */
	export type Canvas2DDrawFunction = (
	 ...
	 *  @memberof Engine */
	export function engineObjectsCollect(
		pos?: Vector2,
		size?: Vector2 | number,
	 ...
	 *  @memberof Engine */
	export function engineObjectsRaycast(
		start: Vector2,
		end: Vector2,
		objects?: Array<EngineObject>
	): Array<EngineObject>;
	...
	export function tile(
		index?: Vector2 | number,
		size?: Vector2 | number,
		texture?: TextureInfo | number,
		padding?: number,
		bleed?: number
	): TileInfo;
	/**
	 ...
	 *  @memberof Draw */
	export function screenToWorldTransform(
		screenPos: Vector2,
		screenSize: Vector2,
		screenAngle?: number
	...
	export function drawCanvas2D(
		...
		angle?: number,
		mirror?: boolean,
		drawFunction?: Canvas2DDrawFunction,
		screenSpace?: boolean,
		context?: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D
	): void;
	 ...
	 *  @param {HTMLImageElement|HTMLCanvasElement|OffscreenCanvas} image
	 *  @memberof WebGL */
	export function glSetTextureData(
	 ...
	 *  @param {CanvasRenderingContext2D|OffscreenCanvasRenderingContext2D} context
	 *  @memberof WebGL */
	export function glCopyToContext(
		context: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D
	): void;
	 ...
	 *  @memberof WebGL */
	export function glDrawPointsTransform(
		points: Array<Vector2>,
		rgba: number,
		x: number,
		y: number,
	 ...
	 *  @memberof WebGL */
	export function glDrawOutlineTransform(
		points: Array<Vector2>,
		rgba: number,
		lineWidth: number,
		x: number,
	 ...
	 *  @memberof Input */
	export function inputClearKey(
		key: string | number,
		device?: number,
		clearDown?: boolean,
		clearPressed?: boolean,
		clearReleased?: boolean
	): void;
	 ...
	 *  @memberof TileLayers */
	export function tileCollisionTest(
		pos: Vector2,
		size?: Vector2,
		object?: EngineObject,
		solidOnly?: boolean
	 ...
	 *  @memberof TileLayers */
	export function tileCollisionRaycast(
		posStart: Vector2,
		posEnd: Vector2,
		object?: EngineObject,
		normal?: Vector2,
	 ...
	 *  @memberof TileLayers */
	export function tileLayersLoad(
		tileMapData: any,
		tileInfo?: TileInfo,
		renderOrder?: number,
	 ...
	 *  @param {number} [angle] - Angle to rotate by
	 *  @memberof DrawUtilities */
	export function drawNineSliceScreen(
		pos: Vector2,
		size: Vector2,
		startTile: TileInfo,
		borderSize?: number,
	 ...
	 *  @param {number} [angle] - Angle to rotate by
	 *  @memberof DrawUtilities */
	export function drawThreeSliceScreen(
		pos: Vector2,
		size: Vector2,
		startTile: TileInfo,
		borderSize?: number,
