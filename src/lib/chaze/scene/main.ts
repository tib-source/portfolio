...
export default class Main extends Scene {
	...
	update() {
		...
		if (
			...
			LJS.keyWasPressed('KeyX') ||
			LJS.gamepadWasPressed(0) ||
			LJS.gamepadWasPressed(2)
		) {
	...
	render() {
		...
		// Glow text
		LJS.engineFontImage.drawTextScreen('CHAZE', LJS.vec2(center, 220), 200, true, glowColor);
